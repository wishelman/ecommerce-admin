...
exports.create = async (req, res) => {
  try {
    ...
    await Activity.create({ admin_id: req.admin.id, activity: `Tambah kategori: ${category_name}` });
...
exports.update = async (req, res) => {
  try {
    ...
    await Activity.create({ admin_id: req.admin.id, activity: `Update kategori id ${req.params.id}` });
...
exports.remove = async (req, res) => {
  try {
    ...
    await Activity.create({ admin_id: req.admin.id, activity: `Hapus kategori id ${req.params.id}` });
